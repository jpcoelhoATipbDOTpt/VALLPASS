...
//byte ReadBatteryVoltage[] = {
//  0x01, // id do dispositivo
//  0x05, // código da função
//  0x00, // ADD_INI_H
//  0x02, // ADD_INI_L
//  0x00, // ADD_NBR_H
//  0x00, // ADD_NBR_L
//}; // manda deligar (modo manual)
...
byte nbrSentBytes = 0; // Numero de bytes enviados
...
void loop() {
  ...
  switch (estado) {
    ...
    case ETAPA1: // Envia comando para o TRACER
      ...
      createModbusFrame(FrameToSend, ReadBatteryVoltage, nbrSentBytes); // Gera frame
